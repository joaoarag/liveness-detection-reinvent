...
import { LivenessChallengeComponent } from './liveness-challenge/liveness-challenge.component';
...
const routes: Routes = [
  ...
  { path: 'validate-face', component: AnswerChallengeComponent, canActivate: [IsNotAuthenticated] },
  { path: 'detect-liveness', component: LivenessChallengeComponent, canActivate: [IsNotAuthenticated] },
